...
<div class="container">
    <div class="container">
        ...
        <a href="Remove_donator.php" class="list-group-item active">Remove donator</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="Remove_donator1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;">  Remove donator from this system </h3>
