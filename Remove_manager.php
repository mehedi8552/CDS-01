      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"> <a href="adminlogin.php">MANAGER CONTROL PANEL</a></li>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="mycds.php" class="list-group-item ">My Restaurant</a>
    		<a href="view_food_items.php" class="list-group-item ">View Food Items</a>
    		<a href="add_food_items.php" class="list-group-item ">Add Food Items</a>
    		<a href="edit_food_items.php" class="list-group-item ">Edit Food Items</a>
    		<a href="Remove_manager.php" class="list-group-item active">Remove manager</a>
        <a href="Remove_donator.php" class="list-group-item ">Remove donator</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="Remove_manager1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Remove manager from this system </h3>
