...
header('Location: mycds.php'); // Redirecting To Home Page
}
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="mycds.php" class="list-group-item active">My Dashbord</a>
    		<a href="view_user_profile.php" class="list-group-item ">View user profile</a>
        <a href="view_manager_profile.php" class="list-group-item ">View manager profile</a>
    		<a href="add_food_items.php" class="list-group-item ">Add Food Items</a>
    		<a href="edit_food_items.php" class="list-group-item ">Edit Food Items</a>
        <a href="Remove_manager.php" class="list-group-item ">Remove manager</a>
